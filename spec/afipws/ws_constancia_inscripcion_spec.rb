  ...
  describe WSConstanciaInscripcion do
    ...
    context 'entorno' do
      it 'debería usar las url para development cuando el env es development' do
        ...
        Client.expects(:new).with(wsdl: 'https://awshomo.afip.gov.ar/sr-padron/webservices/personaServiceA5?WSDL', ssl_version: :TLSv1, soap_version: 1)
      ...
      it 'debería usar las url para production cuando el env es production' do
        ...
        Client.expects(:new).with(wsdl: 'https://aws.afip.gov.ar/sr-padron/webservices/personaServiceA5?WSDL', ssl_version: :TLSv1, soap_version: 1)
